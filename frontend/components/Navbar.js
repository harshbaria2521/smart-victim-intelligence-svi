    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm border-b border-gov-border">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-lg bg-gov-teal text-white flex items-center justify-center font-serif text-lg font-bold shadow-sm group-hover:bg-gov-navy transition-colors">
